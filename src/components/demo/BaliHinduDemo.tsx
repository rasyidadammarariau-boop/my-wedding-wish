        ...
        <div className="relative">
          ...
          <ParallaxSection className="py-20 px-4 bg-gradient-to-b from-red-50 to-white" fadeIn>
            <div className="max-w-4xl mx-auto relative">
              ...
              <FloatingElement className="absolute -top-10 -left-10 text-6xl opacity-30 hidden md:block" intensity={0.8}>
                🌺
              </FloatingElement>
              <FloatingElement className="absolute -top-5 -right-10 text-5xl opacity-30 hidden md:block" intensity={1.2} delay={0.3}>
                🌺
              </FloatingElement>
          ...
          <section className="py-20 px-4 bg-gradient-to-b from-red-50 to-white">
            <div className="max-w-2xl mx-auto">
              ...
              <GuestBook invitationId="bali-hindu-demo" />
            </div>
          </section>
